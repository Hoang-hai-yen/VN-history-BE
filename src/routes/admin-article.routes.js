 ...
 *         description: OK
 */
router.get("/articles", authenticate, ctrl.getAll);
 ...
 */
router.post("/articles/bulk-publish", authenticate, requireSuperAdmin, ctrl.bulkPublish);
 ...
 */
router.get("/articles/:id", authenticate, ctrl.getById);
 ...
 */
router.post("/articles", authenticate, ctrl.create);
 ...
 */
router.put("/articles/:id", authenticate, ctrl.update);
 ...
 */
router.patch("/articles/:id/submit", authenticate, ctrl.submit);
 ...
 */
router.patch("/articles/:id/publish", authenticate, requireAdmin, ctrl.publish);
 ...
 */
router.patch("/articles/:id/reject", authenticate, requireAdmin, ctrl.reject);
 ...
 */
router.patch("/articles/:id/return", authenticate, requireSuperAdmin, ctrl.returnToPending);
 ...
 *   delete:
 *     tags: [Articles]
 *     summary: Xoá bài viết (super_admin only)
 *     security: [{ bearerAuth: [] }]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *         description: Đã xoá
 */
router.delete("/articles/:id", authenticate, requireSuperAdmin, ctrl.remove);
