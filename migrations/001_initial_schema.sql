...
CREATE TABLE IF NOT EXISTS `dynasties` (
  ...
  `year_start`   INT          NOT NULL COMMENT 'Âm = TCN, vd: -2879',
  `year_end`     INT          DEFAULT NULL COMMENT 'NULL nếu chưa kết thúc',
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `year_start`     INT          DEFAULT NULL COMMENT 'Âm = TCN',
...
CREATE TABLE IF NOT EXISTS `article_revisions` (
  ...
  `admin_id`    char(36)     NOT NULL,
  `version`     INT          NOT NULL COMMENT 'Auto-increment per article',
  `title`       varchar(300) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `historical_persons` (
  ...
  `birth_year`   INT          DEFAULT NULL COMMENT 'Âm = TCN',
...
CREATE TABLE IF NOT EXISTS `media` (
  ...
  `duration_sec`  INT        DEFAULT NULL COMMENT 'Chỉ dùng cho video/audio',
